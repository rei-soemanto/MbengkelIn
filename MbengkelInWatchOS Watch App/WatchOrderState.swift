...
// Watch copy. An identical DTO lives in the iOS target (Models/DTOs). The two
// targets share no files, so this small DTO is intentionally duplicated. Decoded
// from the JSON the phone pushes via updateApplicationContext / sendMessage.
